...
import { Diamond, Mail, Lock, Eye, EyeOff, ArrowRight, Key, Shield } from 'lucide-react';
    ...
    <div className="min-h-screen bg-black flex items-center justify-center p-4">
      <div className="bg-[#1c1c1c] border border-white/10 w-full max-w-md p-8 rounded-3xl shadow-2xl relative overflow-hidden">
        ...
        <button 
          ...
          disabled={isLoading}
          className="w-full bg-white text-black hover:bg-gray-200 rounded-xl py-3 font-semibold flex items-center justify-center gap-3 transition-all hover:scale-[1.02] active:scale-95 disabled:opacity-70 disabled:hover:scale-100 mb-8"
        >
